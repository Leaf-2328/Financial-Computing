...
{ // Default call option
  // Default values
	...
	optType = new char[5];
	strcpy(optType, "Call");	// European Call Option (this is the default type)
}
...
EuropeanOption::EuropeanOption (char * optType_)
{	// Create option type
	r = 0.08;
	sig = 0.30;
	K = 65.0;
...
EuropeanOption::EuropeanOption(double r_,
	double sig_,
	double K_,
	double T_,
	double U_,
...
{ // Change option type (Call/Put, Put/Call)
